...
df_locs = [ "go/tmp/cycle_state/blue-beatle/basecase/basecase_1501718249617734560.csv" ]


for df_loc in df_locs:

  df = pd.read_csv(df_loc)
  # df = pd.read_csv("/ssd/share/" + name + "/masters/" + df_loc)
  ...
  qalys_lost_per_case_mrf = 2.1
  qalys_lost_per_case_no_mrf = 3.3
