...
for df_loc in df_locs:
  ...
  # df = pd.read_csv("go/tmp/cycle_state/remotes-oct-5/" + df_loc)
  # df = pd.read_csv("go/tmp/cycle_state/remotes-oct-16/" + df_loc)
  df = pd.read_csv("/hdd/share/iron-tiger_best-guess-10y-testing-at-2016_30-Dec-2016/masters/"  + df_loc)
  ...
  # df["Risk_of_prog_us"] = df["Risk_of_prog_us"] + df["Risk_of_prog_us"] * (df["rand_us"]-0.5)
  # df["Risk_of_prog_fb"] = df["Risk_of_prog_fb"] + df["Risk_of_prog_fb"] * (df["rand_fb"]-0.5)
  ...
  # simulate PSA, remember to take out
  ...
  # elim.loc[:,"Intervention_name"] = "5) Elimination"
  # pre_elim.loc[:,"Intervention_name"] = "6) Pre-elimination"
  ...
  if using_interpolation:
    ...
    error_style = "ci_band" #"unit_traces" #

    if i == 0:
      sns.tsplot(time="Year", value="Risk_of_prog_total", interpolate=True, unit="Iteration_num", linewidth=0.2, err_style=error_style, ci=[5, 95], condition="Intervention_name", color=colors, data=qdf[qdf.Year > 2014], ax=axarr[0][0])
      axarr[0][0].plot(pre_elim["Year"],pre_elim["Risk_of_prog_total"], marker="None", color='black', linestyle='--', linewidth=1, alpha=0.8, label="Pre-elimination")
      axarr[0][0].plot(elim["Year"],elim["Risk_of_prog_total"], marker="None", color='black', linestyle=':', linewidth=1, alpha=0.8, label="Elimination")
    if i == 1:
      sns.tsplot(time="Year", value="Risk_of_prog_total", interpolate=True, unit="Iteration_num", linewidth=0.2, err_style=error_style, ci=[5, 95], condition="Intervention_name", color=colors, data=qdf[qdf.Year > 2014], ax=axarr[0][1])
      axarr[0][1].plot(pre_elim["Year"],pre_elim["Risk_of_prog_total"], marker="None", color='black', linestyle='--', linewidth=1, alpha=0.8, label="Pre-elimination")
      axarr[0][1].plot(elim["Year"],elim["Risk_of_prog_total"], marker="None", color='black', linestyle=':', linewidth=1, alpha=0.8, label="Elimination")
    if i == 2:
      sns.tsplot(time="Year", value="Risk_of_prog_total", interpolate=True, unit="Iteration_num", linewidth=0.2, err_style=error_style, ci=[5, 95], condition="Intervention_name", color=colors, data=qdf[qdf.Year > 2014], ax=axarr[1][0])
      axarr[1][0].plot(pre_elim["Year"],pre_elim["Risk_of_prog_total"], marker="None", color='black', linestyle='--', linewidth=1, alpha=0.8, label="Pre-elimination")
      axarr[1][0].plot(elim["Year"],elim["Risk_of_prog_total"], marker="None", color='black', linestyle=':', linewidth=1, alpha=0.8, label="Elimination")
    if i == 3:
      sns.tsplot(time="Year", value="Risk_of_prog_total", interpolate=True, unit="Iteration_num", linewidth=0.2, err_style=error_style, ci=[5, 95], condition="Intervention_name", color=colors, data=qdf[qdf.Year > 2014], ax=axarr[1][1])
      axarr[1][1].plot(pre_elim["Year"],pre_elim["Risk_of_prog_total"], marker="None", color='black', linestyle='--', linewidth=1, alpha=0.8, label="Pre-elimination")
      axarr[1][1].plot(elim["Year"],elim["Risk_of_prog_total"], marker="None", color='black', linestyle=':', linewidth=1, alpha=0.8, label="Elimination")
...
plt.savefig("major_figure_" + time.strftime("%Y-%m-%d-%Hh%Mm") + ".png", bbox_inches='tight', dpi=300)
