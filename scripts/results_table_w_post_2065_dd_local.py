...
df_locs = [ "med-risk-factor_1495163486288872180.csv"]


for df_loc in df_locs:

  df = pd.read_csv("go/tmp/cycle_state/blue-beatle/basecase/basecase_1501718249617734560.csv")
  ...
  qalys_lost_per_case_mrf = 1.0 # same for now
  qalys_lost_per_case_no_mrf = 1.6
...
final_df.T.to_csv("go/tmp/cycle_state/blue-beatle/masters/" + "final_df_" + time.strftime("%Y-%m-%d-%Hh%Mm") + ".csv")
final_raw_df.to_csv("go/tmp/cycle_state/blue-beatle/masters/final_raw_df_" + time.strftime("%Y-%m-%d-%Hh%Mm") + ".csv")
