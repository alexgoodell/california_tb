...
other = ["Life", "LTBI treated with RTP", "Uninfected TB", "Black", "Asian", "White", "Other", "Hispanic" ]
...
ggl = '/hdd/share/'+ simulation_name +'/' + "basecase" + '/*.csv'
print ggl
df_locs = glob(ggl)
i = 0
...
master_df.to_csv("/hdd/share/" + simulation_name + '/masters/basecase-limited-master.csv')
print "/hdd/share/" + simulation_name + '/masters/basecase-limited-master.csv'
