...
df_locs = [ "med-risk-factor_1495163486288872180.csv", "fb_1495158677665750959.csv", "fb-and-med-risk-factor_1495161878900940062.csv", "full-pop_1495160281647690330.csv" ]
...
for df_loc in df_locs:
  print df_loc
  df = pd.read_csv("go/tmp/cycle_state/blue-beatle/masters/" + df_loc)
  # initial processing
...
best_guess_df_locs = [ "med-risk-factor_1495163486288872180.csv", "fb_1495158677665750959.csv", "fb-and-med-risk-factor_1495161878900940062.csv", "full-pop_1495160281647690330.csv" ]
...
plt.savefig("go/tmp/cycle_state/blue-beatle/masters/major_figure_" + time.strftime("%Y-%m-%d-%Hh%Mm") + ".png", bbox_inches='tight', dpi=300)
