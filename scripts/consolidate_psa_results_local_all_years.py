...
for rtype in rtypes:
	...
	ggl = '/ssd/share/'+ simulation_name +'/' + rtype + '/*.csv'
	print ggl
	df_locs = glob(ggl)
	i = 0
	...
	master_df.to_csv("/ssd/share/" + simulation_name + '/' + rtype + "-limited-master.csv")
	print "/ssd/share/" + simulation_name + '/results/' + rtype + "-limited-master.csv"
